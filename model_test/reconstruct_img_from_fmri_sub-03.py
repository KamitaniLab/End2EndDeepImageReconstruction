...
generator_caffemodel_file = '../trained_model/trainedmodel_sub-03/generator.caffemodel'  # the caffemodel file for the trained generator
generator_prototxt_file = '../trained_model/trainedmodel_sub-03/generator_test.prototxt'  # the prototxt file for the generator
...
test_fmri_data_file = '../fmri_data/sub-03_perceptionNaturalImageTest_original_VC.h5'  # the file of the test fmri data
training_fmri_data_file = '../fmri_data/sub-03_perceptionNaturalImageTraining_original_VC.h5'  # the file of the training fmri data
